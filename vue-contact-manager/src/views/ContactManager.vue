        ...
        <div class="row">
            <div class="col">
                <p class="h3 text-light fw-bold">
                    Contact Manager
                    <router-link to="/contacts/add" class="btn btn-light btn-sm"><i class="fa fa-plus-circle"></i>
                        New</router-link>
                </p>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-1 d-flex flex-column justify-content-center align-items-center">
                                <router-link :to="`/contacts/view/${contact.id}`" class="btn btn-light my-1">
                                    <i class="fa fa-eye"></i>
                                </router-link>
                                <router-link :to="`/contacts/edit/${contact.id}`" class="btn btn-light my-1">
                                    <i class="fa fa-pen"></i>
                                </router-link>
                                <button class="btn btn-light my-1" @click="clickDeleteContact(contact.id)">
